...
I'm a Software Engineer from *Kolkata*. Looking forward to move my career in **FullStack** Development.
...
Currently I'm focusing on increasing my knowledge on *Microservices* architecture. Learning about various CI/CD tools and methods, and also getting invested in **Cloud**.
...
<p tyling/scss.png" height="67" hspace="10">
...
<img src="./assets/tools/androidstudio.png" height="40" hspace="20"> May sound weird but I prefer *WebStorm* over *VSCode*.

<img src="./assets/tools/vscode.png" height="45" hspace="20"> Use *VSCode* for viewing projects quickly.

<img src="./assets/tools/deepin.png" height="45" hspace="20"> Started with *Windows*. Then switched to *Ubuntu*. That was my first introduction to Linux. Finally found out about **Deepin**, and I instaly fall in love with it. And don't have plans to hop any time soon. 😌

<br>

> I've an *Ideapad* 100 from Lenovo. With a dual core 5000u processor. I've upgraded my rom to 8GB, and replaced the HDD with a *Samsung 850 EVO* SSD, and put the hard disk in the disk drive caddy. This trusty guy is severing me for 6 years and counting. 🥰
...
- [x] 😏 And of course smug smiling with my girlfriend [Shuktika](https://github.com/Shuktika15) without who made a valuable contribution in making this readme. Love you as always. 😘
